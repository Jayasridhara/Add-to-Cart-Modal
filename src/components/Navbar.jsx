  ...
  return (
    <header className="bg-white shadow-lg sticky top-0 z-10">
      <nav className="container mx-auto px-4 py-4 flex justify-between items-center no-wrap">
        <h1 className="text-3xl font-bold text-gray-800 font-jaro">Jash e Kart</h1>
        <button onClick={openModal} className="relative transform transition-transform duration-200 hover:scale-110">
